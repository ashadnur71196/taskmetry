...
const services = [
  {
    icon: "📊", label: "Data Services", color: "#00C8F0",
    items: ["Data Entry & Collection", "Data Cleaning", "Excel & Google Sheets", "CRM Management"],
    desc: "Accurate, scalable data solutions tailored to your business workflow.",
  },
  {
    icon: "💻", label: "Web Development", color: "#7C3AED",
    items: ["Frontend & Backend Dev", "WordPress & E-commerce", "React / Next.js Apps", "API Integration"],
    desc: "High-performance websites and web apps built to convert and grow.",
  },
  {
    icon: "🔍", label: "SEO", color: "#F5A623",
    items: ["Technical SEO Audits", "Local & National SEO", "Content Optimization", "Link Building"],
    desc: "Rank higher, get found faster, and drive organic growth consistently.",
  },
  {
    icon: "🎬", label: "Video Editing", color: "#F87171",
    items: ["Short-form Content", "Motion Graphics", "Thumbnail Design", "YouTube Editing"],
    desc: "Scroll-stopping video content that captivates and builds your brand.",
  },
  {
    icon: "🤝", label: "Virtual Assistance", color: "#34D399",
    items: ["Admin & Scheduling", "Email Management", "Customer Support", "Research & Reporting"],
    desc: "Reliable remote VAs that free your time and keep operations smooth.",
  },
  {
    icon: "🌍", label: "Remote Staffing", color: "#818CF8",
    items: ["Dedicated Remote Teams", "Outsourcing Solutions", "Talent Matching", "Managed Teams"],
    desc: "Build your dream team globally without the overhead costs.",
  },
];
...
const testimonials = [
  {
    name: "Sarah M.", role: "Founder, eCommerce Brand — USA",
  ...
  {
    name: "James K.", role: "CEO, SaaS Startup — UK",
  ...
  {
    name: "Priya R.", role: "YouTube Creator — Canada",
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text)", overflowX: "hidden" }}>
      ...
      <section id="services" style={{ padding: "100px 5%", position: "relative" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20, maxWidth: 1200, margin: "0 auto" }}>
          {services.map((s, i) => (
            <div key={s.label} className="card fade-up" style={{ animationDelay: `${i * .08}s`, position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ marginTop: 20, paddingTop: 18, borderTop: "1px solid var(--border)" }}>
                <button onClick={() => document.getElementById("contact").scrollIntoView({ behavior: "smooth" })}
                  style={{ background: "none", border: "none", cursor: "pointer", color: s.color, fontSize: 14, fontWeight: 600, fontFamily: "DM Sans", display: "flex", alignItems: "center", gap: 6 }}>
                  Get a Quote →
                </button>
              </div>
            </div>
